    ...
    <div className="home-container">
      ...
      <div data-role="Header" className="home-navbar-container">
        <div className="home-navbar">
          <span className="home-heading">Guhan M</span>
      ...
      <div className="home-container02">
        <div className="home-hero">
          <div className="home-hero-text-container">
            <h1 className="home-heading2">A PASSIONATE AI STUDENT </h1>
            <span className="home-text">
               I am a passionate Artificial Intelligence and Data Science
              Student
            </span>
            <div className="home-cta-btn-container">
              <button className="home-cta-btn Anchor button">
                <span className="home-text01">MY WORK</span>
              </button>
      ...
      <div className="home-about">
        <div className="home-max-content-width-container">
          <div className="home-heading-container1">
            <h1 className="Section-Heading home-text07">
      ...
      <div className="home-clients">
        <div className="home-heading-container2">
          <h1 className="home-text17 Section-Heading">Clients</h1>
      ...
      <div className="home-pricing">
        <div className="home-heading-container3">
          <h1 className="home-text19 Section-Heading">Ask for a quote</h1>
          ...
          <div className="home-card5">
            ...
            <div className="home-card-content2">
              <div className="home-container13">
                <span className="Card-Text">Feature one</span>
                <span className="home-text30 Card-Text">TBD</span>
              </div>
              <div className="home-container14">
                <span className="Card-Text">Feature two</span>
                <span className="home-text32 Card-Text">TBD</span>
              </div>
              <div className="home-container15">
                <span className="Card-Text">Feature three</span>
                <span className="home-text34 Card-Text">UNLIMITED</span>
              </div>
              <div className="home-container16">
                <span className="Card-Text">Feature four</span>
                <span className="home-text36 Card-Text">UNLIMITED</span>
              </div>
      ...
      <div className="home-subscribe">
        ...
        <div className="home-container17">
          <div className="home-heading-container4">
            <h1 className="home-text38 Section-Heading">
              Get our guide to crafting digital products
            </h1>
            <span className="Section-Text home-text39">
